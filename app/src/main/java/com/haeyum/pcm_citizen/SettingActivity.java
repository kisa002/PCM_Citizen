    ...
    public void onClick(View v)
    {
        switch(v.getId())
        {
            ...
            case R.id.btn_history:
                onAlert("업데이트 내역", "2017.02.26 이전 데이터 복구\n2017.02.27 학생등록 추가\n2017.02.28 시간표 알고리즘 변경\n2017.03.01 일정표 알고리즘 변경\n2017.03.02 급식 오류 수정 및 알고리즘 변경\n2017.03.04 설정 메뉴 추가 및 레이아웃 색상과 아이콘 변경\n2017.03.05 레이아웃 색상 변경 및 메뉴 추가, Splash 변경\n2017.03.06 레이아웃 대폭 변경\n2017.03.07 간단한 튜토리얼 추가 및 타 기종 설치 오류 해결\n2017.03.28 도서 검색 추가\n2017.03.29 6시 이후 다음 시간표(버그 있지만 귀찮..)\n2017.04.09 메인 액티비티에 도서 검색 버튼 추가 및 재업로드");
                break;
